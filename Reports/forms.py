...
class DisasterForm(forms.Form):
    ...
    water_damage=forms.BooleanField(required=False, label='Is there water damage in your home?')

    water_mobilehome=forms.BooleanField(required=False, label='Do you have a mobile home?')
    ...
    sewage = forms.BooleanField(required=False, label='Is there more than 1 foot of sewage in your home?')
